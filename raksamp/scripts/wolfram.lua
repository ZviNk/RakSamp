...
<<<<<<< HEAD
                local action = findListInDialog(text, style, "��������� ������ � ��������� �����");
...
<<<<<<< HEAD
        local nick = text:match("��� ����������������: {E9967A}([%w_]+)");
        local admin = text:match("��� ������������: {E9967A}([%w_]+)");
        local reason = text:match("�������: {E9967A}([^\n]+)"):gsub("\\n", "");
        local ban_date = text:match("���� ����: {E9967A}([%d%-: ]+)");
        local unban_date = text:match("���� �������: {E9967A}([%d%-: ()��.]+)");
        local guarantor = text:match("���������������: {E9967A}([%w_]+)");
        local bail = text:match("����� ������: {E9967A}%$(%d+)");
=======
...
<<<<<<< HEAD
        local list = findListInDialog(text, style, "����� ����������");
=======
